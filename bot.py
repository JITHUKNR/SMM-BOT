...
# ✅ QR CODE FILE ID (നിങ്ങൾ അയച്ചുതന്നത് ഇവിടെ സെറ്റ് ചെയ്തു)
QR_CODE_FILE_ID = "AgACAgQAAxkBAAI0UGluU4Bg0onFlgUgedyzb0RO0uYCAALYDGsbpjJwU0ieEncrdtqiAQADAgADeAADOAQ"

# ⚠️ നിങ്ങളുടെ UPI ID ഇവിടെ എഴുതുക (യൂസർക്ക് കാണാൻ വേണ്ടി)
            ...
            try:
                ...
                if 'order' in res:
                    ...
                    if "balance" in error_msg.lower():
                        await context.bot.send_message(ADMIN_ID, "⚠️ **ADMIN ALERT:** Main SMM Account Low Balance!")
